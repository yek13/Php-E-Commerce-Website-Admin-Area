        ...
        <div class="panel"><!-- panel begin -->
            <div class="panel-body"><!-- panel-body begin -->
                <div class="mb-md thumb-info"><!-- mb-md thumb-info begin -->
                    ...
                    <img src="admin_images/2.png" alt="admin-thumb-info" class="rounded img-responsive">
                    
                    <div class="thumb-info-title"><!-- thumb-info-title begin -->
                       
                        <span class="thumb-info-inner"> YEK </span>
                ...
                <div class="mb-md"><!-- mb-md begin -->
                    <div class="widget-content-expanded"><!-- widget-content-expanded begin -->
                        <i class="fa fa-user"></i> <span> Email: </span> yek@gmail.com <br/>
                        <i class="fa fa-flag"></i> <span> Country: </span> Turkey <br/>
                        <i class="fa fa-envelope"></i> <span> Contact: </span> 0533-3213-3333 <br/>
